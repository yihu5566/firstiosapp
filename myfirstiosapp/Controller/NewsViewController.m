...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self.tabBarController.navigationItem setTitleView:({
        ...
        UIButton *uiButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH-UI(20), self.navigationController.navigationBar.frame.size.height)];
        uiButton.backgroundColor = [UIColor grayColor];
        [uiButton addTarget:self action:@selector(_showCommentView) forControlEvents:UIControlEventTouchUpInside];
        uiButton;
